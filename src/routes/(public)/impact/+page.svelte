  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <ScrollReveal animation="fade-down">
      <div class="text-center text-white mb-16">
        <CmsText key="impact.hero.title" tag="h1" class="text-5xl md:text-7xl font-bold mb-6">Notre Impact</CmsText>
        <CmsText key="impact.hero.subtitle" tag="p" class="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">Chaque produit Angel's Floor transforme des vies et construit un avenir durable</CmsText>
      </div>
    </ScrollReveal>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <ScrollReveal animation="fade-up">
      <div class="text-center mb-16">
        <CmsText key="impact.stories.title" tag="h2" class="text-4xl md:text-5xl font-bold text-primary-green mb-4">Histoires de Transformation</CmsText>
        <CmsText key="impact.stories.subtitle" tag="p" class="text-xl text-neutral-charcoal max-w-3xl mx-auto">Rencontrez les femmes courageuses qui sont le cœur d'Angel's Floor</CmsText>
      </div>
    </ScrollReveal>
...
<section class="py-20 bg-neutral-sand">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <ScrollReveal animation="fade-up">
      <div class="text-center mb-16">
        <CmsText key="impact.process.title" tag="h2" class="text-4xl md:text-5xl font-bold text-primary-green mb-4">Notre Processus de Collaboration</CmsText>
        <CmsText key="impact.process.subtitle" tag="p" class="text-xl text-neutral-charcoal max-w-3xl mx-auto">Un partenariat équitable du champ à votre table</CmsText>
      </div>
    </ScrollReveal>
...
<section class="py-20 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <ScrollReveal animation="fade-up">
      <div class="text-center mb-16">
        <CmsText key="impact.metrics.title" tag="h2" class="text-4xl md:text-5xl font-bold text-primary-green mb-4">Impact Économique Mesurable</CmsText>
        <CmsText key="impact.metrics.subtitle" tag="p" class="text-xl text-neutral-charcoal max-w-3xl mx-auto">Des chiffres qui racontent une histoire de transformation durable</CmsText>
      </div>
    </ScrollReveal>
...
<section class="py-20 bg-gradient-to-br from-primary-green via-primary-green-vibrant to-accent-gold relative overflow-hidden">
  ...
  <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
    <ScrollReveal animation="scale">
      <CmsText key="impact.cta.title" tag="h2" class="text-4xl md:text-5xl font-bold mb-6">Faites Partie de Cet Impact</CmsText>
      <CmsText key="impact.cta.description" tag="p" class="text-xl text-white/90 mb-10">Chaque achat contribue directement à transformer des vies et à bâtir un avenir durable pour les communautés béninoises.</CmsText>
